export const IconeCartao = () => (
  <svg className="icone" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const IconeOlhoAberto = () => (
  <svg className="icone-senha" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
    <circle cx="12" cy="12" r="3"/>
  </svg>
)
